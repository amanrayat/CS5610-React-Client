...
class CourseService {
    ...
    findCourseById = (courseId)=>{
        return axios("https://mysterious-crag-36104.herokuapp.com/api/course/"+courseId)

    };

    findAllCourses = ()=>{
        return axios({
            url:"https://mysterious-crag-36104.herokuapp.com/api/course",
            method: 'get',
    ...
    deleteCourse = (courseId)=>{
        return axios({
            url :"https://mysterious-crag-36104.herokuapp.com/api/course/"+courseId,
            method :'delete',
            withCredentials: true,
        })
    ...
    findAllModulesForCourseId = (courseId) => {
        return axios({
            url : "https://mysterious-crag-36104.herokuapp.com/api/course/"+courseId+"/module",
            method : 'get',
            withCredentials: true,
        });
    ...
    deleteModuleForCourseId = (moduleId) => {
        return axios({
            url :"https://mysterious-crag-36104.herokuapp.com/api/module/"+moduleId,
            method : 'delete',
            withCredentials: true
        })
    };
    ...
    findAllLessonsForModule = (moduleId)=>{
        return axios({
            url : "https://mysterious-crag-36104.herokuapp.com/api/module/"+moduleId+"/lesson",
            method:'get',
            withCredentials: true,
        })
    };
    ...
    deleteLessonForModuleId = (lessonId)=>{
        return axios({
            url : "https://mysterious-crag-36104.herokuapp.com/api/lesson/" + lessonId,
            method : 'delete',
            withCredentials: true
        })
    };
    ...
    findAllTopicForModule = (LessonId)=>{
        return axios({
            url : "https://mysterious-crag-36104.herokuapp.com/api/lesson/"+LessonId+"/topic",
            method : 'get',
            withCredentials: true,
        })
    ...
    deleteTopicForLessonId =(topicId)=>{
        return axios({
            method : 'delete',
            url: "https://mysterious-crag-36104.herokuapp.com/api/topic/"+topicId,
            withCredentials: true
        })
    };
