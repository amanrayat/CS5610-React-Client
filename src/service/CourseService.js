...
class CourseService {
    ...
    createWidget = (topicId)=> {
        ...
        let widget = {"type" : "HEADING", "size": 1,"text": "AutoGenerated Text" };

        return axios({
            method : 'post',
            url : "http://localhost:8080/api/topic/"+topicId+"/headingwidget" ,
            data : widget,
            withCredentials: true,
        })
    };
    ...
    deleteWidget = (widgetId)=>{
        axios({
            method : 'delete',
            url: "http://localhost:8080/api/widget/"+widgetId,
            withCredentials: true
        }).then((res)=>{
            return res
        });
