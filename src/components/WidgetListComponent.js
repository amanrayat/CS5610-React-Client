            ...
            <ul className='list-group'>
                ...
                </div>
                {
                    this.props.widgets.map((widget,index) =>
                        <div className={'my-3'}>
                            <li key={widget.id} className={this.props.preview?"list-group":"list-group-item"}>
                                {console.log("the prop here is ", this.props)}
                                <div className={'row'} style={this.props.preview?{"display": "none"}:{"display": ""}}>
                                    <div className={'col-6'}>
                ...
                <button style={this.props.preview?{"display": "none"}:{"display": "inline"}} className={'btn float-right my-5 btn-primary'} onClick={()=>this.props.addWidget()}>
